...
class JointPoseSolver:
    def __init__(self, sequence_folder, debug=False) -> None:
        ...
        self._save_folder = Path(f"{self._data_folder.parent.parent}/{self._folder_name}_annotated/{self._sequence_name}/processed/joint_pose_solver")
        self._save_folder.mkdir(parents=True, exist_ok=True)
        self._annotated_folder = Path(f"{self._data_folder.parent.parent}/{self._folder_name}_annotated/{self._sequence_name}")
