...
#
# Resume-safe per chunk: with --skip_existing, chunks whose
...
TOTAL_EXP=0; OK_CHUNK=0; FAIL_CHUNK=0; SKIP_CHUNK=0
FAILED_CHUNKS=()
...
for EXP_DIR in "$TASK_FOLDER_ABS"/*/; do
    ...
    while [[ $CHUNK_START -le $GLOBAL_END ]]; do
        ...
        rm -f "$H5_PATH"   # always rebuild per chunk
...
echo ""
echo "=========================================="
echo "Summary: experiments=$TOTAL_EXP  chunks_ok=$OK_CHUNK  chunks_skipped=$SKIP_CHUNK  chunks_failed=$FAIL_CHUNK"
